...
@AllArgsConstructor
@NoArgsConstructor
public class PaginaDeLivrosDTO {

    private List<LivroRetornoDTO> conteudo;
    ...
    public PaginaDeLivrosDTO(Page<LivroRetornoDTO> pagina) {
        this.conteudo = pagina.getContent().stream().map(LivroRetornoDTO::new).collect(Collectors.toList());
